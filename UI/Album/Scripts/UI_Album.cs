...
public class UI_Album : MonoBehaviour
{
    ...
    void PosicionarContent(UI_Foto foto)
    {
        ...
        scrollRect.content.SetupAndPlay(lector, new Animacio_RectPosicio(scrollRect.content.anchoredPosition, new Vector2(posicio, 0), Corba.EasyInEasyOut), 1, 0, Transicio.clamp, false);
